  ...
  return (
    <Box>
      ...
      <Form name={FormEvents.SettingsUpdated}>
        ...
        <Text color='muted' size='sm' alignment='center'>If you have an Aura API key you can provide it here, to increase your request rate limits. If no API key is provided the public API can still be used.</Text>
        ...
        <Box alignment='center' direction='horizontal'><Text>or</Text></Box>
